...
RAW_INSERT_SCRIPT = "MOGG_TRIGGER = false;
MOGG_RELOAD = false;
mogg_body = document.getElementsByTagName('body')[0];
...
mogg_reload_button = document.createElement('button');
mogg_reload_button.innerHTML = 'Reload';mogg_reload_button.style.cssText = 'position: fixed;display: block;left: 2%;top: 35%;z-index:1000;';
mogg_reload_button.onclick = function(){MOGG_TRIGGER = false; MOGG_RELOAD = true;};
